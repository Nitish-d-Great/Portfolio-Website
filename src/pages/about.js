      ...
      <ol className="career-path">
        ...
        <div className="border-l-2 border-[var(--border-secondary)] pl-4">
          ...
          <a
            ...
            href="https://www.linkedin.com/in/nitish-gupta-2676b5250/details/experience/"
          >
      ...
      <div className="about">
        ...
        <main>
          ...
          <div className="bio column">
            ...
            A blockchain developer with keen interest towards Back-end Development and focus on Smart Contract Security along with zero-knowledge cryptography, building projects that lie at the intersection of privacy and decentralization. With multiple hackathon wins, I've developed ZK-powered applications and alongside audited smart contracts using tools like Slither and Mythril.
            </p>
            <p className="paragraph">
              I'm really focused towards resolving real-world problems through cryprography,
              specifically Zero-Knowledge proofs and Smart Contracts Security.
            </p>
            <ul className="control">
              ...
              <li>
                <a className="button -icon" href={NitishCV} download={true}>
                  <FiDownload />
                  <p>Download CV</p>
                </a>
              </li>
...
export const Head = () => <title>Me | Know Nitish</title>;
